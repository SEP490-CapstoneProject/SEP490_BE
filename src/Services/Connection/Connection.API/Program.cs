...
.AddJwtBearer(options =>
{
    ...
    options.Events = new JwtBearerEvents
    {
        OnMessageReceived = context =>
        {
            ...
            if (!string.IsNullOrEmpty(accessToken) && path.StartsWithSegments("/hubs/realtime"))  // ✅ Changed from /hubs/chat to /hubs/realtime
            {
...
app.MapControllers();
app.MapHub<Connection.API.Hubs.ChatHub>("/hubs/realtime");  // ✅ Changed from /hubs/chat to /hubs/realtime
